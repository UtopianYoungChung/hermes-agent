...
from . import (  # noqa: E402
    ...
    methods_session_control as _methods_session_control, methods_group_transcript as _methods_group_transcript)
...
for _m in (
    ...
    _methods_session_control, _methods_group_transcript):
